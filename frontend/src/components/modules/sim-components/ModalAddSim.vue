<template>
   <div class="modal fade" style="margin-top:32px !important;" id="newSim" tabindex="-1" aria-labelledby="" aria-hidden="true">
    <div class="modal-dialog modal-md rounded-0">
        <div class="modal-content rounded-0">
            <div class="modal-header rounded-0 ag-color-2">
                <h5 class="modal-title " style="margin-left: auto;color:white">Nouveau Carte SIM</h5>
            ...
            <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="row g-3 align-items-center mb-20">
                            <div class="col-4">
                                <label for="prenom" class="col-form-label">Ligne</label>
                            </div>
                            <div class="col-8">
                        ...
                        <div class="row g-3 align-items-center mb-20">
                            <div class="col-4">
                                <label for="email-1" class="col-form-label">Numero SIM</label>
                            </div>
                            <div class="col-8">
            ...
            <div class="modal-footer footer-bg">
                ...
                <button type="submit" name="addClient" class="btn btn-sm text-nowrap ag-color-10-hover ag-color-10" data-bs-dismiss="modal" @click="addNewSim()">Enregistrer</button>
            </div>
        </div>
    </div>
</div>
...
export default {
  ...
  methods: {
    addNewSim () {
        ...
        this.$api.simApi.creatSim(params)
            .then((data) => {
                this.notifyEvent();
    ...
    notifyEvent(isSuccess = true) {
        if(isSuccess){
            this.$notify('Le nouvel carte SIM a bien été créé.',{
                    type: 'success',
                    showIcon: 'true',
